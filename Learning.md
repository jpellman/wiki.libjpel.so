...
This page contains notes from the MOOC [Learning How to Learn](http/www.coursera.olealearning-how-to-lea) on Coursera. I expect there to be much overlap in scope and content between this and [Memory](Memory).
...
-   Focused thought is analogous to conscious, task-related thought. Could also be analogous to Csikszentmihalyi's [flow](http/en.wikipedia.owiFlow_(psychology)) or a telgoal-oriented state.
-   Diffuse thought is analogous to the [default mode network](http/en.wikipedia.owiDefault_mode_network).
...
-   LTM like a warehouse, distributed over an area. LTM is a NoSQL database? Repetition of fact procedures when learning is like a manual replication procedure sort of?
...
-   Coffcaffeine then is not inherently bad in the short-term, but can prevent a necessary cleaning.
-   Sleep prunes unwanted info, strengthens wanted info (sort of like deduplication).
-   Sleep is diffuse mod dmn on steroids; allows connections to be made that might not otherwise be made under the watchful eye of the prefrontal cortex.
...
-   Get a sense of a pattern for what you want to learn (i.e., listen or watch someone playing to learn a song; mentorshi learning from someone else who has more mastery). Learn specific mini-chunks (i.e., musical phrases for a song). Synthesize these mini-chunks into a larger chunk.
-   Goal is to make a chunk second natur not hard to activate (i.e., language).
-   Learning at the start involves a heavy cognitive load, so it makes sense to use exampl toy problems and try to imitate them. Like working up gradually from 1 mile runs to 5k to 15k. Worked out solutions are a resource- you still need to use your own judgement to construct chunks.
-   A step-by-step overview of a general chunking process:
    1.  Focus on the information that you would like to chusynthesize (i.e., turn off your phone, minimize interrupts).
...
-   Making a semantic map for studyin organizing before you actually have a mental map in your head is not as effective.
-   Re-readings **are** effective when spaced.
-   Common illusions of competence:
    -   Reading a worked out problem and feeling that you totally understand it conceptually, but you haven't put any mental effort into it yoursel haven't actively learned it so you don't actually know it. Exposur superficial understanding alone is not enough.
...
-   The best way to know if you're *actually* learning is to test yourself. Recall can be seen as a mini-test. Any mistakes you make in your self-test can be used to re-educate yourself (for systems administration, this is what lab testing environments are for).
...
-   Transfer: Concepts and problem-solving methods from one field can help yo be re-appropriated for use in another field.
...
-   Overlearning is generally good if you can establish some level of automaticity for a skil knowledge.
...
-   Re-learning something you've already learned can make you feel better at something than you are, since you've actually only mastered the easy stuff and not moved on to harder topics (i.e., there's always something more difficult to lear fields are nuanced).
...
-   If you reinforce your initial idea, you need to unlearn it (i.e., if you are taught that ego depletion or any of the numerous non-replicable effects in psychology are trvalid, it may be harder to pivot your paradigm).
-   Interleaving: Switching between using different toooperators in different situations. Try using different concepts, procedures, etc. Skip between different chapters.
...
-   Techniques
    ...
    -   [What Marcus Aurelius said](http/i.imgur.cgrqGb9B.jpg)
...
-   Multimodal learning is good. The instructors champion co-opting visuospatial systems (since they are more evolutionary well-honed) in particular (citing [this](htt/www.ncbi.nlm.nih.gpubm21926985))- related to method of Loci.
-   A discussion of HM.
-   A discussion of mnemonics- including making up phrase acronyms and the method of Loci. Mnemonics don't incur a penalty to get to semi-skilled expertise (?)
-   Spacing works because it invokes reconsolidating memorie updating them from an inactive state, thus making them stronger (i.e., some amount of elaboration must occur when the memories are being re-consolidated; [I don't think this is the traditional view of this theory however](htt/blogs.discovermagazine.cneuroskept20time-to-rethink-the-reconsolidation-theory-of-memo#.V5UM75MrKRs))

Week 4
------

-   Periods where there is difficulty in understanding new knowledg skills might be reflective of a period of mental re-structuring.
-   Creating metaphor relations to concepts can help learning (also can help in creating new knowledge, e.g., fluidic view of electricity in 18th century).
...
-   What you learn from one source is only one part of the big picture (i.e., it's a good idea to seek out many different text learning material lectures and synthesize them yourself).
-   The right hemisphere is biased towards big picture thinking (though leright dichotomy is not strict). Right hemisphere = "devil's advocate" that questions status quo, left hemisphere is more rigid.
-   Social study sessions can help you realize knowledge gaps (as long as everyone's prepared and on-topic).
-   [A checklist for tests](htt/www4.ncsu.eunilockeusef/feldpublColummemo.pdf)
